...
('Sofía', 'Hernandez', 1, '43890123', '1993-11-11', TRUE, NOW(), 1, NOW(), 1, 'sofiahernandez', '12345678', 45678),
('Luis', 'Garcia', 1, '42987654', '1988-09-30', TRUE, NOW(), 1, NOW(), 1, 'luisgarcia', '12345678', 90123),
('Laura', 'Rojas', 1, '40654321', '2000-02-20', TRUE, NOW(), 1, NOW(), 1, 'laurarojas', '12345678', 56789),
('Jose', 'Torres', 1, '43210987', '1975-05-22', TRUE, NOW(), 1, NOW(), 1, 'josetorres', '12345678', 12367),
('Carmen', 'Diaz', 3, '23455948169', '1987-12-10', TRUE, NOW(), 1, NOW(), 1, 'carmentorres', '12345678', 23478),
('Ana', 'Perez', 1, '41234568', '1990-04-12', TRUE, NOW(), 1, NOW(), 1, 'anaperez', '12345678', 67834),
('Luis', 'Perez', 1, '41234569', '2010-05-25', TRUE, NOW(), 1, NOW(), 1, 'luisperez', '12345678', 23499),
('Martin', 'Gonzalez', 1, '39876544', '1992-08-25', TRUE, NOW(), 1, NOW(), 1, 'martingonzalez', '12345678', 34534),
('Clara', 'Gonzalez', 1, '39876545', '2011-02-20', TRUE, NOW(), 1, NOW(), 1, 'claragonzalez', '12345678', 56750),
('Raul', 'Lopez', 1, '41238946', '1981-01-15', TRUE, NOW(), 1, NOW(), 1, 'raullopez', '12345678', 67899),
('Maria', 'Lopez', 1, '41238947', '2012-03-10', TRUE, NOW(), 1, NOW(), 1, 'marialopez', '12345678', 89001),
('Isabel', 'Martinez', 1, '44556678', '1993-07-01', TRUE, NOW(), 1, NOW(), 1, 'isabelmartinez', '12345678', 34523),
('Santiago', 'Martinez', 1, '44556679', '2010-06-01', TRUE, NOW(), 1, NOW(), 1, 'santiagomartinez', '12345678', 56712),
('Roberto', 'Ramirez', 1, '40785622', '1984-05-05', TRUE, NOW(), 1, NOW(), 1, 'robertoramirez', '12345678', 12389),
('Lucia', 'Ramirez', 1, '40785623', '2010-10-11', TRUE, NOW(), 1, NOW(), 1, 'luciaramirez', '12345678', 45601),
('Juliana', 'Hernandez', 1, '43890124', '1995-11-12', TRUE, NOW(), 1, NOW(), 1, 'julianahernandez', '12345678', 78945),
('Pedro', 'Hernandez', 1, '43890125', '2012-02-21', TRUE, NOW(), 1, NOW(), 1, 'pedrohernandez', '12345678', 23456),
('Antonio', 'Garcia', 1, '42987655', '1989-10-30', TRUE, NOW(), 1, NOW(), 1, 'antoniogarcia', '12345678', 90145),
('Eva', 'Garcia', 2, '1242987656', '2013-05-20', TRUE, NOW(), 1, NOW(), 1, 'evagarcia', '12345678', 12342),
...
('Felix', 'Torres', 1, '43210988', '1980-05-25', TRUE, NOW(), 1, NOW(), 1, 'felixtorres', '12345678', 78934),
